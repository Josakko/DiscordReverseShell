...
def obfuscate():
    ...
    try:
        ...
        subprocess.run(f"pyminifier -o build/modules/firefox.py build/modules/firefox.py", stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, shell=True)# modules/firefox.py
